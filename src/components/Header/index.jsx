    ...
    <header className="bg-gradient-primary border-b border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Language Selector & Search - Desktop */}
          <div className="hidden md:flex items-center space-x-4">
            <select className="bg-transparent text-white border border-border rounded-md px-3 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-primary-cyan">
              <option value="en" className="bg-dark-card text-white">English</option>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-dark-card/50 backdrop-blur-sm rounded-lg mt-2">
              <Link 
                to="/" 
