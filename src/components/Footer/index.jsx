            ...
            <form onSubmit={handleSubscribe} className="mb-6">
              <div className="flex flex-col sm:flex-row">
                <input
                  ...
                  className="flex-1 px-4 py-2 bg-dark-card border border-border rounded-l-md sm:rounded-r-none rounded-r-md text-white placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-primary-cyan focus:border-transparent mb-2 sm:mb-0"
                  required
                />
                <button
                  type="submit"
                  className="px-6 py-2 bg-gradient-primary text-white rounded-r-md sm:rounded-l-none rounded-l-md hover:opacity-90 transition-opacity duration-200 font-medium"
                >
                  Subscribe
                </button>
              </div>
